...
set output 'Polinomio.pdf'    #Establece el noombre del archivo de salida
...
set title 'Polinomio Aproximante'
set xlabel "x"
set ylabel "y"

plot "Pol Minimos Cuadrados.txt" using 1:2 title 'Polinomio' with lines lw 2 lc 1,\
     "PuntosPlotMC.txt" using 1:2 title 'Puntos f(x)' with points pt 3
